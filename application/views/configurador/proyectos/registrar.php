        ...
        <div class="card border-light shadow-sm components-section">
            <div class="card-body">
                <div class="container-fluid">
                    <div class="card-title">Los campos marcados con <span class="text-danger">*</span> son requeridos</div>
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select class="form-select" id="fuente_financiamiento" aria-label="Fuente de Financiamiento">
                                <option selected disabled>Seleccione una opción</option>
